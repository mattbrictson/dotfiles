export CONFLUENT_HOME=/Users/bomartin/swtools/confluent-7.4.0
...
alias kstart='cd ~/swtools/kafka-stack-docker-compose/ && docker-compose -f zk-single-kafka-single.yml up --detach; cd -'
