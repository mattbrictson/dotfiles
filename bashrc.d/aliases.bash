...
alias ekstools='docker run -it -v ~/.aws:/root/.aws -v ~/.kube:/root/.kube -v ~/ekstools:/home/ekstools lirio-docker.jfrog.io/eks-tools-team:0.4.1'
alias gd='git diff'
...
alias kstat='confluent status'
alias kstart='confluent start kafka'
alias kstop='confluent stop kafka'
